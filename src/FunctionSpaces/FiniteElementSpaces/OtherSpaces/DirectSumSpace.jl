...
struct DirectSumSpace{manifold_dim, num_components, num_patches, F} <:
    ...
    function DirectSumSpace(
        ...
        #     for i in 1:1:num_components
        #         if component_idx != i && component_spaces[component_idx] === component_spaces[i]
        #             throw(ArgumentError("The function spaces on different components need to be different instances."))
        #         end
        #     end
        # end
