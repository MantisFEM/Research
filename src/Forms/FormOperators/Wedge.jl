...
struct Wedge{manifold_dim, form_rank, expression_rank, G, F1, F2} <:
    ...
    function Wedge(
        ...
        if form_rank > manifold_dim
            throw(
                ArgumentError(
                    """\
    The resulting form rank ($(form_rank) = $form_rank_1 + $form_rank_2) exceeds the \
    ...
    function Wedge(
        ...
        G1,
        G2,
        F1 <: AbstractForm{manifold_dim, form_rank_1, expression_rank_1, G1},
        F2 <: AbstractForm{manifold_dim, form_rank_2, expression_rank_2, G2},
    }
        @warn "Different geometries in the wedge!"
        form_rank = form_rank_1 + form_rank_2
        expression_rank = expression_rank_1 + expression_rank_2
        if form_rank > manifold_dim
            throw(
    ...
    """
        ...
        return new{manifold_dim, form_rank, expression_rank, G1, F1, F2}(
            form_1, form_2, label
        )
    end
end
...
function evaluate(
    ...
    element_id::Int,
    xi::Points.AbstractPoints{manifold_dim},
) where {manifold_dim, form_rank, expression_rank, G, F1, F2}
...
# k-forms ∧ 0-forms (expression_rank_1 > 0 & expression_rank_2 > 0)
function _evaluate_wedge(
    form_expression_1::AbstractForm{manifold_dim, form_rank_1, expression_rank_1, G1},
    form_expression_2::AbstractForm{manifold_dim, 0, expression_rank_2, G2},
    element_id::Int,
    xi::Points.AbstractPoints{manifold_dim},
) where {manifold_dim, form_rank_1, expression_rank_1, expression_rank_2, G1, G2}
    # Evaluate the two forms that make up the wedge product
    form_expression_1_eval, form_expression_1_indices = evaluate(
        form_expression_1, element_id, xi
    )  # k-form
